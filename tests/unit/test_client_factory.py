...
class TestAPIFactory(unittest.TestCase):
    ...
    def test_create_spark_emr_client_success(
        ...
        mock_emr_client_class.assert_called_once()
        call_args = mock_emr_client_class.call_args[0][0]
        self.assertIsInstance(call_args, ServerConfig)
        self.assertEqual(call_args.emr_cluster_arn, emr_cluster_arn)
        self.assertEqual(call_args.url, "http://original-url:18080")
